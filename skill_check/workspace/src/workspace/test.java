	...
	public static String solution(String sentence) {
		...
		while(!sentence.equals("")) {
			...
			if('a'<=c && c<='z') {
				...
				try{c = sentence.charAt(1);}catch(Exception e) {return "invalid";}
				if('a'<=c && c<='z') {
					try {
